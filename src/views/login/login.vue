...
<div class="register-index">
        ...
        <div class="body-info">
            ...
            <div class="body-l" v-if="forget">
                <div class="body-l" v-if="forgetStep==1">
                    ...
                    <el-form :model="forgetForm" size="small" validate-on-rule-change :rules="dataRule" ref="forgetForm">
                ...
                <div class="body-l" v-if="forgetStep==2">
                    ...
                    <el-row :gutter="20">
                        ...
                        <el-col :span="10">
                            <el-button size="small" style="width:100%" @click="getVertify" v-if="sendAuthCode">获取验证码
                            </el-button>
                            <el-button size="small" style="width:100%" disabled v-if="!sendAuthCode">{{auth_time}}秒
                            </el-button>
                        </el-col>
                    </el-row>
    ...
    <div class="register-body" v-else>
        <div class="contentR">
            ...
            <el-form style="width:80%" :model="forgetForm" validate-on-rule-change :rules="dataRule" ref="forgetForm">
                ...
                <el-form-item>
                    <el-input maxlength="6" placeholder="填写验证码" v-model="verify">
                        <div slot="append">
                            <el-button size="small" style="width:100%" v-if="sendAuthCode">获取验证码
                            </el-button>
                            <el-button size="small" style="width:100%" disabled v-if="!sendAuthCode">{{auth_time}}秒
                            </el-button>
                        </div>
