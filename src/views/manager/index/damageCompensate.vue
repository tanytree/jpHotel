  ...
  <div class="boss-index">
        ...
        <div class="content">
          <div class="right">
            <el-button
              ...
              class="submit"
              size="small"
              @click="popup_kinds('add')"
            >{{$t('manager.hp_addType')}}</el-button>
          </div>
          <el-table
            ref="multipleTable"
            :data="list"
            ...
            <el-table-column :label="$t('commons.operating')" width="300">
              <template slot-scope="scope">
                <el-button
                  type="text"
                  size="small"
                  @click="popup_kinds('edit', scope.row)"
        ...
        <div class="content">
          <el-form v-model="form" class="term line demo-form-inline" inline size="small">
            ...
            <el-form-item :label="$t('manager.hp_goodsType')+':'">
              <el-select v-model="form.category" :placeholder="$t('boss.compensation_selectState')">
                <el-option
    ...
    >
      ...
      >
        ...
        <el-form-item :label="$t('manager.hp_compensationPrice')+':'" prop="name">
      ...
      <div slot="footer" class="dialog-footer">
        <el-button class="white" @click="addGoodsVisible = false">{{$t('commons.cancel')}}</el-button>
        <el-button
          type="primary"
          class="submit"
          @click="submit('addGoods')"
        >{{$t('commons.determine')}}</el-button>
      </div>
    </el-dialog>
  </div>
...
export default {
  ...
  computed: {
    inputActiveName: {
      get() {
        return this.$t("manager.hp_inputActiveName");
      },
      set() {},
    },
    addType: {
  ...
  watch: {
    inputActiveName(newValue, oldValue) {
      this.inputActiveName = newValue;
    },
