    ...
    <div>
        <el-row class="demo-form-inline">
            <div class="tag-group">
                ...
                >{{ $t('commons.all') + '(' + F_roomStatus('', 'total') + ')' }}
                </el-tag>
                <el-tag
        ...
        <el-row class="demo-form-inline">
            <div class="tag-group">
                ...
                <el-tag
                    effect="plain"
                    class="tag-width2 margin-l2"
                >{{ $t('commons.all') + '(' + F_roomStatus('roomType', 'total') + ')' }}
                </el-tag>
                <el-tag
                    ...
                    effect="plain"
                    class="tag-width2 margin-l2"
                >{{ (item.houseName || $t('manager.hp_unknown')) + '(' + item.total + ')' }}
                </el-tag>
            </div>
        </el-row>
...
export default {
    ...
    methods: {
        ...
        get_realtime_hotel_room_list() {
            ...
            this.$F.doRequest(
                this, "/pms/realtime/realtime_hotel_room_list", params,
        (res) => {
