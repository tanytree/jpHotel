<template>
  <div class="boss-index">
    <div class="content">
      <div class="btn-item">
        <div
          ...
          :key="index"
          class="btn-default"
          :class="currentIndex==item.id? 'btn-active':''"
      ...
      <div class="into">
        ...
        <div class="components-edit">
          ...
          >
            ...
            <el-table-column prop="soteageType" :label="$t('manager.grsl_wareType')"></el-table-column>
            <el-table-column prop="creatorName" :label="$t('manager.grsl_makingPeople')"></el-table-column>
            <el-table-column prop="authStatus" :label="$t('boss.loginDetail_state')"></el-table-column>
            <el-table-column :label="$t('commons.operating')" width="300">
              <template slot-scope="scope">
                ...
                >{{$t('manager.grsl_theDetail')}}</el-button>
                <el-button
                  type="text"
                  size="small"
                ...
                <el-button
                  type="text"
                  size="small"
                  @click="popup('exam', scope.row)"
                >{{$t('manager.grsl_audit')}}</el-button>
                <el-popconfirm
    ...
    <el-dialog
      top="0"
      :title="$t('manager.grsl_warehousingAudit')"
      width="600px"
      :visible.sync="inHouseExamVisible"
      :close-on-click-modal="false"
    >
