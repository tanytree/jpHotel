        ...
        <div class="content">
          <el-form class="term line demo-form-inline" inline size="small" v-model="form">
            ...
            <el-form-item class="form-inline-flex">
              <el-button @click="popup('add')" class="white">{{$t('commons.exportBtn')}}</el-button>
            </el-form-item>
          </el-form>
      ...
      >
        <el-form-item :label="$t('manager.grsl_wareType')+':'" prop="name">
          <el-select v-model="goodInForm.type" :placeholder="$t('manager.grsl_selectWareType')">
            <el-option :label="$t('manager.grsl_areaOne')" value="shanghai"></el-option>
            <el-option :label="$t('manager.grsl_areaTwo')" value="beijing"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item class="form-inline-flex">
          <el-button
