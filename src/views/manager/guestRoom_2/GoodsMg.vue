      ...
      <el-form class="term line demo-form-inline" v-model="form" inline size="small">
        ...
        <el-form-item class="form-inline-flex">
          <el-row class="form-inline-flex">
            <el-button
              class="white"
              @click="downModel('dynamicValidateForm')"
            >{{$t('commons.downloadTemplate')}}</el-button>
          ...
          <el-table-column :label="$t('commons.operating')" width="350">
            <template slot-scope="scope">
              ...
              <el-button
                ...
                size="small"
                disabled
              >{{$t('manager.grsl_hasFailure')}}</el-button>
              <el-button
                type="text"
                size="small"
                disabled
    ...
    <div class="content" v-if="!tab_show">
      ...
      <div class="footer">
        ...
        <el-button
          ...
          class="submit"
          @click="submit"
        >{{$t('manager.grsl_saveAndAdd')}}</el-button>
