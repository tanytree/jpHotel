            ...
            <el-row v-for="(value, index) in cengList" :key="index">
                ...
                >
                    ...
                    <el-row>
                        ...
                        >
                            <el-table-column prop="roomTypeId" :label="$t('manager.hp_room')"></el-table-column>
                            <el-table-column prop="houseNum" :label="$t('manager.hk_roomNum')"></el-table-column>
                        </el-table>
                        <el-row
                            style="padding:20px 0px 10px 0px;"
                        >{{$t('manager.hk_floorNote')+':'}}</el-row>
                ...
                >
                    <el-col :span="20">
                        <el-form-item :label="$t('manager.hk_buildingName')+':'" prop="name">
                            <el-input
                                :placeholder="$t('manager.hk_inputBuildName')"
                                v-model="ruleForm_dong.name"
                            ></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="20">
