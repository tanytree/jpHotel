			...
			<el-dialog top="0" :title="jiageSit_title" :visible.sync="jiageSit_show" :close-on-click-modal="false">
				<el-row :gutter="20">
					...
					<el-form :model="ruleForm_sit" :rules="rules" ref="ruleForm_ceng" label-width="150px">
						<el-col :span="20">
							<el-form-item label="1人住宿:" prop="name">
								<el-input :placeholder="$t('boss.department_placeEnterContent')" v-model="ruleForm_sit.one"></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="20">
				...
				<span slot="footer" class="dialog-footer">
					...
					<el-button type="primary" @click="changeJiageSit">{{$t('commons.determine')}}</el-button>
				</span>
			</el-dialog>
		</div>
	</el-row>
