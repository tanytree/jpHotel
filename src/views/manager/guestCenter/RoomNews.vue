          ...
          <el-col :span="10">
            <el-row class="form-inline-flex" style="margin-bottom: 20px;">
              ...
              <el-button
                ...
                size="mini"
                @click="stop('gaowen')"
              >{{$t('manager.hk_batchTemperature')}}</el-button>
            </el-row>
          </el-col>
        </el-row>
          ...
          >
            ...
            <el-table-column prop="roadFlag" :label="$t('manager.hk_byRoad')">
              <template slot-scope="{row}">
                ...
                <span v-if="row.roadFlag == 2">{{$t('manager.hk_no')}}</span>
              </template>
            </el-table-column>
            <el-table-column prop="windowFlag" :label="$t('manager.hk_ifWindow')">
              <template slot-scope="{row}">
                <span v-if="row.windowFlag == 1">{{$t('manager.hk_yes')}}</span>
                <span v-if="row.windowFlag == 2">{{$t('manager.hk_no')}}</span>
              </template>
            </el-table-column>
            <el-table-column :label="$t('manager.hk_ifNoiseRoom')">
              <template slot-scope="{row}">
                <span v-if="row.noiseFlag == 1">{{$t('manager.hk_yes')}}</span>
                <span v-if="row.noiseFlag == 2">{{$t('manager.hk_no')}}</span>
              </template>
            </el-table-column>
            <el-table-column :label="$t('manager.hk_ifTemperatureRoom')">
              <template slot-scope="{row}">
                <span v-if="row.temperatureFlag == 1">{{$t('manager.hk_yes')}}</span>
                <span v-if="row.temperatureFlag == 2">{{$t('manager.hk_no')}}</span>
              </template>
            </el-table-column>
            <el-table-column prop="state" :label="$t('boss.loginDetail_state')">
              <template slot-scope="{row}">
                <span v-if="row.state == 1">{{$t('commons.enable')}}</span>
                <span v-if="row.state == 2">{{$t('commons.disable')}}</span>
              </template>
            </el-table-column>
