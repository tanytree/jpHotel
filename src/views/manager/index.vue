...
<template>
	<div>
		<el-tabs class="pageTab" v-model="activeName">
					...
					<el-form :model="threeForm" :rules="threerules" ref="ruleForm" label-width="100px">
						...
						<el-col :span="8">
							<el-form-item label="入住时间:" prop="name">
								<el-date-picker v-model="threeForm.name" type="datetime" placeholder="选择日期时间" align="right" :picker-options="pickerOptions" style="width: 200px;"></el-date-picker>
							</el-form-item>
						</el-col>
						<el-col :span="8">
			...
			<!-- 员工权限 -->
			<el-tab-pane label="员工权限" name="seven">
