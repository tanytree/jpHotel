          ...
          <el-table-column :label="$t('commons.operating')" width="350">
            <template slot-scope="scope">
              ...
              <el-popconfirm
                ...
                @onConfirm="get_price_enter_strategy_delete(scope.row)"
              >
              ...
              <el-button
                type="text"
                size="small"
                @click="popup('changerili')"
              >{{$t('manager.ps_modifyCalendar')}}</el-button>
            </template>
          </el-table-column>
        </el-table>
      </div>
...
export default {
  ...
  computed: {
    addSuccess: {
      get() {
        return this.$t("manager.ps_addSuccess");
      },
      set() {},
    },
    deleteSuccess: {
    ...
    upword: {
      get() {
        return this.$t("manager.ps_upword");
      },
      set() {},
    },
    down: {
      get() {
        return this.$t("manager.ps_down");
      },
      set() {},
    },
    fourAndFive: {
      get() {
        return this.$t("manager.ps_fourAndFive");
      },
      set() {},
    },
    keep: {
      get() {
        return this.$t("manager.ps_keep");
      },
      set() {},
    },
  },
  watch: {
    addSuccess(newValue, oldValue) {
      this.addSuccess = newValue;
    },
    deleteSuccess(newValue, oldValue) {
      this.deleteSuccess = newValue;
    },

    upword(newValue, oldValue) {
      this.upword = newValue;
    },
    down(newValue, oldValue) {
      this.down = newValue;
    },
    fourAndFive(newValue, oldValue) {
      this.fourAndFive = newValue;
    },
    ...
    hotel_price_enter_strategy_detail(value) {
      ...
      this.$F.doRequest(
        ...
        (res) => {
          ...
          switch (res.discounts) {
            case "1":
              res.discounts_name = this.upword;
              break;
            case "2":
              res.discounts_name = this.down;
              break;
            case "3":
              res.discounts_name = this.fourAndFive;
              break;
            case "4":
              res.discounts_name = this.keep;
              break;
          }
