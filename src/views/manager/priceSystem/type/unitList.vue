        ...
        >
          ...
          <el-table-column :label="$t('boss.loginDetail_state')">
            <template slot-scope="{ row }">
              <span>{{
                row.state ? $t("commons.enable") : $t("commons.disable")
              }}</span>
            </template>
          </el-table-column>
          <el-table-column
            prop="ruleName"
            :label="$t('boss.loginDetail_note')"
          ></el-table-column>
    ...
    <el-row v-if="!tab1_show">
      ...
      <el-row :gutter="20">
        <el-form :model="ruleForm" :rules="rules" ref="ruleForm">
          ...
          <el-col span="20">
            <el-form-item
              :label="$t('manager.grsl_selectTime') + ':'"
              prop="time"
            >
              <el-date-picker
        ...
        <el-table-column :label="$t('manager.ps_changPriceWay')">
          <template slot-scope="{ row, $index }">
            <el-row class="demo-form-inline">
              ...
              >
                <el-option
                  :label="$t('manager.ps_discount')"
                  :value="1"
                ></el-option>
                <el-option
                  :label="$t('manager.ps_fixedPrice')"
                  :value="2"
                ></el-option>
              </el-select>
      ...
      <el-row style="padding: 20px 0px">
        <el-button type="primary" style="width: 80px" @click="onSave">{{
          $t("commons.save")
        }}</el-button>
        <el-button style="width: 80px; margin-left: 20px; cursor: pointer">{{
          $t("commons.back")
        }}</el-button>
      </el-row>
    </el-row>
    ...
    >
      <el-row style="line-height: 30px">
        ...
        <el-row>
          ...
          <el-col span="14">{{
            detail_info.state == 1 ? "启用" : "禁用"
          }}</el-col>
        </el-row>
        <el-row>
          <el-col span="4" style="color: #898b8e">时间:</el-col>
          <el-col span="14"
            >{{ detail_info.startTime }}至{{ detail_info.endTime }}</el-col
          >
        </el-row>
        <el-row>
          <el-col span="4" style="color: #898b8e">星期:</el-col>
          <el-col span="14">
            <span v-for="(value, index) in detail_info.weeks"
              >{{ value }},</span
            >
          </el-col>
        </el-row>
