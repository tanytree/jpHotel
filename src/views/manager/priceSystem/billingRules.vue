  ...
  <div>
    <el-row>
      <el-tabs v-model="activName">
        <el-tab-pane :label="$t('manager.ps_allDayRoom')" name="a">
          <allDay></allDay>
        </el-tab-pane>
        <el-tab-pane :label="$t('manager.ps_clockRoom')" name="b">
          <timep></timep>
        </el-tab-pane>
        <el-tab-pane :label="$t('manager.ps_getMoneyRule')" name="c">
          <jifei></jifei>
        </el-tab-pane>
      </el-tabs>
    </el-row>
...
import timep from "./rules/timep";
import jifei from "./rules/jifei";
export default {
  components: {
    allDay,
    timep,
