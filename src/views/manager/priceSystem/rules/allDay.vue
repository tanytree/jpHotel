      ...
      <el-row :gutter="20">
            ...
            <el-form-item :label="$t('manager.ps_priceModel')+':'" class="margin-l-15">
              <el-select v-model="ruleForm.priceModel" style="width: 120px">
                <el-option
                  :label="value.name"
                  :value="value.key"
                  v-for="(value, index) in priceModelList"
                  :key="index"
                ></el-option>
              </el-select>
            </el-form-item>
            <el-form-item :label="$t('boss.loginDetail_state')+':'" class="margin-l-15">
              <el-select v-model="ruleForm.state" style="width: 120px">
                <el-option
                  :label="value.name"
                  :value="value.key"
                  v-for="(value, index) in statelList"
                  :key="index"
                ></el-option>
              </el-select>
            </el-form-item>
        ...
        <div class="components-edit">
          ...
          >
            ...
            <el-table-column prop="priceModel" :label="$t('manager.ps_priceModel')"></el-table-column>
            ...
            <el-table-column :label="$t('commons.operating')" width="200">
              <template slot-scope="scope">
                ...
                <el-popconfirm
                  ...
                  @onConfirm="deleteRow_d(scope.row)"
                >
          ...
          <el-col :span="20">
            <el-form-item :label="$t('manager.ps_startPrice')+':'" prop="checkinStartMinute">
              <el-col>
                {{$t('manager.ps_inLive')+':'}}
                <el-input
                  v-model="allForm.checkinStartMinute"
                  style="width: 70px;margin: 0px 10px;"
                ></el-input>
                {{$t('manager.ps_minterGet')}}
                <el-input
                  v-model="allForm.checkinStartHourhouse"
                  style="width: 70px;margin: 0px 10px;"
                ></el-input>
                {{$t('manager.ps_getAll')}}
              </el-col>
          ...
          <el-col :span="20">
            <el-form-item :label="$t('manager.hp_checkOutTime')+':'" prop="name">
              <el-row style="display: flex;align-items: center;">
                ...
                <el-time-select
                  v-model="allForm.checkoutTime"
                  :picker-options="{
								    start: '08:30',
								    step: '00:15',
								    end: '18:30'
								  }"
                  :placeholder="$t('manager.grsl_selectTime')"
                ></el-time-select>
              </el-row>
            </el-form-item>
          </el-col>
          <el-col :span="20">
            <el-form-item :label="$t('manager.ps_thenTime')+':'" prop="name">
              <el-col :span="20">
                ...
                <el-checkbox
                  v-model="allForm.outtimeRuleCaps"
                  class="margin-l-15"
