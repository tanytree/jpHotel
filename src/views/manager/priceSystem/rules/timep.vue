...
=======
  <div>
          ...
          <el-form class="demo-form-inline" inline size="small">
            ...
            <el-form-item :label="$t('manager.ps_priceModel')+':'" class="margin-l-15">
              <el-select v-model="ruleForm.priceModel" class="row-width">
                <el-option label="1" :value="$t('manager.ps_fixedTime')"></el-option>
                <el-option label="2" :value="$t('manager.ps_everyTime')"></el-option>
              </el-select>
            </el-form-item>
            <el-form-item>
              <el-button
    ...
    <el-row v-if="!tab_show">
      ...
      <el-row :gutter="20">
        ...
        >
          <el-col :span="20" style="display: flex;align-items: center;">
            ...
            <el-checkbox
              v-model="ruleForm_h.state"
              class="margin-l-15"
              style="margin-bottom: 20px;"
            >{{$t('commons.enable')}}</el-checkbox>
          </el-col>
          <el-col :span="20" style="margin-bottom: 20px;">
            <el-row :gutter="20" style="display: flex;align-items: center;">
              <el-col style="width: 200px; padding: 0;">
                <el-checkbox
                  v-model="ruleForm_h.name"
                  class="margin-l-15"
                  style="margin-right: 15px;"
                >{{$t('manager.ps_specifiedTime')+':'}}</el-checkbox>
              </el-col>
              <el-col>
                <el-date-picker
                  v-model="ruleForm_h.time"
                  type="daterange"
                  align="right"
          ...
          <el-col :span="20" style="margin-bottom: 20px;">
            <el-form-item
              :label="$t('manager.ps_startPrice')+':'"
              prop="checkinStartMinute"
              style="display: flex;align-items: center;"
            >
              <el-col>
                {{$t('manager.ps_inLive')}}
                <el-input
                  v-model="ruleForm_h.checkinStartMinute"
                  style="width: 70px;margin: 0px 10px;"
                ></el-input>
                {{$t('manager.ps_minterGet')}}
                <el-input
                  v-model="ruleForm_h.checkinStartHourhouse"
                  style="width: 70px;margin: 0px 10px;"
                ></el-input>
          ...
          <el-col :span="20">
            <el-form-item :label="$t('manager.ps_thenTimeRule')+':'">
              ...
              <el-checkbox
                v-model="ruleForm_h.outtimeRuleCaps"
                class="margin-l-15"
              >{{$t('manager.ps_addSky')}}</el-checkbox>
            </el-form-item>
          </el-col>
          <el-col :span="20">
      ...
      <el-table
        ref="multipleTable"
        :data="ruleForm_h.roomStrategyJson"
        tooltip-effect="dark"
        :header-cell-style="{background:'#F7F7F7',color:'#1E1E1E'}"
      >
...
export default {
  data() {
    return {
      ...
      rules_h: {
        checkinStartMinute: [
          { required: true, message: "请输入起步收费", trigger: "blur" },
        ],
        outtimeMinute: [
          { required: true, message: "请输入超时收费", trigger: "blur" },
        ],
      },
      ruleForm_r: {
        memberId: "",
...
>>>>>>> 71d6277b2b918c5d8039345a45ee72581fb40bc6
</script>
