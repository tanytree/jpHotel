<!--
 * @Date: 2020-04-23 14:55:12
 * @LastEditors: Dana
 * @LastEditTime: 2020-04-23 15:42:21
 * @FilePath: /cloudAdmin/src/views/purchase/contract/index.vue
 -->
...
<template>
  ...
  <el-form-item style="float:right">
          <el-button type="primary" @click="addoreditList('')">新增</el-button>
        </el-form-item>
    ...
    <addOredit v-if="editShow" ref="editShowRef" @refreshDataList="getDataList" />
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    addoreditList(id) {
      this.editShow = true;
      this.$nextTick(() => {
        this.$refs.editShowRef.initData(id, 2);
      });
    },
    // 删除
    deleteHandle(id) {
