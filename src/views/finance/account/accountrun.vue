        ...
        >
          ...
          >
            <template slot-scope="scope">
              ...
              >{{$t('manager.finance_proCredentials')}}</el-button>
            </template>
          </el-table-column>
        </el-table>
        <div
          class="total"
        >{{$t('manager.finance_income')+':'}} {{income}} {{$t('manager.ps_japanYen')}} {{$t('manager.finance_spending')+':'}}{{expand}} {{$t('manager.ps_japanYen')}} {{$t('manager.finance_profits')+':'}}{{profit}}{{$t('manager.ps_japanYen')}}（{{$t('manager.finance_only')}}）</div>
      </div>
    </el-card>
    <el-dialog
      top="0"
