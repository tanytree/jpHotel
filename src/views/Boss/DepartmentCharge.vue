<template>
    <div class="boss-index">
        ...
        <el-dialog top="0" title="设为负责人" :visible.sync="dialogTableVisible" :close-on-click-modal="false"
                   @close="closeDialog">
...
<script>
  export default {
    ...
    mounted () {
      this.get_tableDate()
      this.activeName = this.$F.filterThirdMenu('boss', 'department-charge', false, true).path
    },
    methods: {
      //获取负责人列表
      get_tableDate () {
