    ...
    <div>
        <el-card>
            ...
            <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange"
                           :current-page="searchForm.pageIndex" :page-sizes="[10, 50, 100, 200]"
                           :page-size="searchForm.pageIndex" layout=" sizes, prev, pager, next, jumper"
                           :total="listTotal"></el-pagination>
        </el-card>
        <!-- 编辑or详情弹窗 -->
        <el-dialog top="0" :title="addUserForm.type=='add'?'添加门店':'修改门店'" :visible.sync="setUserFormVisible"
                   class="setUserForm" width="600px">
            ...
            <div slot="footer" class="dialog-footer">
                ...
                <el-button type="primary" @click="submitItem" v-loading="loading">确认</el-button>
            </div>
        </el-dialog>
    </div>
</template>
        ...
        this.$refs.editForm.validate((valid) => {
            ...
            if (valid) {
              ...
              if (this.addUserForm.type == 'add') {
                ...
                this.$F.doRequest(this, '/pms/workuser/edit_stores_user', params, (res) => {
                  this.setUserFormVisible = false
                  this.initForm()
                })
              }
