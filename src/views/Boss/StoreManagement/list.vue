  ...
  <div>
    <el-card>
      ...
      <el-table ref="multipleTable" v-loading="loading" :data="tableData" :header-cell-style="{background:'#F7F7F7',color:'#1E1E1E'}" size="medium">
        <el-table-column prop="storesName" :label="$t('boss.store_storeName')" show-overflow-tooltip></el-table-column>
        <el-table-column prop="userName" :label="$t('boss.store_storeManagers')" show-overflow-tooltip></el-table-column>
        <el-table-column prop="storesAddress" :label="$t('boss.store_address')" show-overflow-tooltip></el-table-column>
          ...
          <el-row class="cell">
            <el-col :span="18" class="col">
              <el-form-item :label="$t('boss.store_loginPassword')+':'" prop="password" class>
                <el-input v-model="addUserForm.password" type="password" @input="passwordChange"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row class="cell">
