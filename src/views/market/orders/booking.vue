 ...
 * @LastEditTime: 2020-10-21 16:47:39
  ...
  <div class="boss-index">
      ...
      <el-form class="term" inline size="small" label-width="100px">
        ...
        <el-row>
          <el-form-item :label="$t('desk.order_dateList') + ':'">
            <el-tag type="info">{{$t('desk.home_noLimit')}}</el-tag>
            <el-tag type="info">{{$t('desk.customer_lastWeek')}}</el-tag>
            <el-tag type="info">{{$t('desk.customer_today')}}</el-tag>
            <el-tag type="info">{{$t('desk.customer_thisWeek')}}</el-tag>
            <el-tag type="info">{{$t('desk.order_nextWeek')}}</el-tag>
            <el-tag type="info">{{$t('desk.book_theCustom')}}</el-tag>
          </el-form-item>
          <!--<el-form-item label="">
        ...
        <el-row>
          ...
          <el-form-item :label="$t('desk.home_roomType')">
            <el-select v-model="searchForm.enterStatus" class="width150">
              <el-option
                :label="item.houseName ? item.houseName : $t('desk.home_unknown')"
        ...
        <el-row>
          ...
          <el-form-item>
            ...
            <el-button type="primary" @click="initForm">{{$t('commons.exportBtn')}}</el-button>
          </el-form-item>
        </el-row>
      </el-form>
      <!--表格数据 -->
    ...
    >
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="confirmNoshow">{{$t('commons.confirm')}}</el-button>
      </span>
    </el-dialog>
    <!--交订金-->
