    ...
    <div class="booking">
      ...
      >
        ...
        <el-table-column prop label="房间号">
          <template slot-scope="{row}">{{row.hotelCheckInRoom?row.hotelCheckInRoom.houseNum:''}}</template>
        </el-table-column>
        ...
        <el-table-column prop="consumeTotalPrice" label="总消费" width="120" align="center">
          <template slot-scope="{row}">{{row.memberObject?row.memberObject.consumeTotalPrice:''}}</template>
        </el-table-column>
