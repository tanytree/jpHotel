<template>
  <div class="sec1">
    <el-form :inline="true" class="top-body" label-width="80px">
      <el-form-item label="商品名称">
        <el-input v-model="form.name" style="width:180px" placeholder="请输入"></el-input>
      </el-form-item>
      <el-form-item label="产品类型">
        <el-select v-model="form.status" style="width:150px" placeholder="审核状态">
          <el-option label="分类1" value="shanghai"></el-option>
          <el-option label="分类2" value="beijing"></el-option>
        </el-select>
      </el-form-item>
      <el-form-item label="一级分类">
        <el-select v-model="form.status" style="width:180px" placeholder="审核状态">
          <el-option label="分类1" value="shanghai"></el-option>
          <el-option label="分类2" value="beijing"></el-option>
        </el-select>
      </el-form-item>
