<template>
  <div class="yun-edit">
    <el-form :inline="true" class="demo-form-inline">
      ...
      <br />
      <el-button :disabled="dataListSelections.length <= 0" type="primary"  plain size="mini" @click="toAdd">批量同意</el-button>
      <el-button :disabled="dataListSelections.length <= 0" type="danger" plain  size="mini" @click="toAdd">批量拒绝</el-button>
      ...
      >
        ...
        <el-table-column label="操作" width="250">
          <template slot-scope="scope">
            ...
            <el-button size="mini" @click="editPriceF(scope.row)">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
      <div class="block">
