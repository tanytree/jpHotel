<template>
    <div class="boss-index">
                ...
                <el-table-column :label="$t('commons.operating')">
                    <template slot-scope="{ row }">
                        <el-button
                            size="small"
                            type="text"
                            @click="noteDdetail(row)"
                            >{{ $t("commons.detail") }}</el-button
                        >
                        <el-button
                            size="small"
                            type="text"
                            @click="noteDelete(row)"
        ...
        >
            ...
            <el-row>
                <el-col :span="3">{{
                    $t("desk.home_messEmployees") + ":"
                }}</el-col>
                <el-col :span="12">{{ messageDetail.creatorName }}</el-col>
            </el-row>
            <el-row>
                <el-col :span="3">{{
                    $t("desk.home_messContent") + ":"
                }}</el-col>
