            ...
            <el-table :data="tableData" style="width: 100%;margin-bottom: 20px;" row-key="id" border
                ...
                <el-table-column :label="$t('commons.operating')" width="220">
                    <template slot-scope="{row}">
                        <el-button type="text" v-if="!row.isChild" size="mini" @click="addHandle(row)">
                            {{ $t('boss.personnel_addDepart') }}
                        </el-button>
                        <el-button type="text" v-if="row.isChild" size="mini" @click="editHandle(row)">
                            {{ $t('manager.hp_editor') }}
                        </el-button>
                        <el-button type="text" v-if="row.isChild" size="mini" @click="deleteItem(row)">
                            {{ $t('commons.delete') }}
                        </el-button>
                    </template>
                </el-table-column>
