...
<div>
    ...
    <el-dialog top="0" :title="foreignForm.type=='add'?'登记外宾':'编辑外宾'" :visible.sync="setForeignFormVisible" class="setForeignForm" width="1200px">
                ...
                <el-row class="cell">
                    ...
                    <el-col :span="6" class="col">
                        <el-form-item label="证件编号" class="" prop="idcard">
                            <el-input v-model="foreignForm.idcard" class="width150"></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row class="cell">
                    ...
                    <el-col :span="6" class="col">
                        <el-form-item label="有效时间" class="" prop="dueTime">
                            <el-date-picker v-model="foreignForm.dueTime" value-format="yyyy-MM-dd" type="date" style="width:150px" placeholder="选择日期"></el-date-picker>
                        </el-form-item>
                    </el-col>
                    <el-col :span="6" class="col">
                    ...
                    <el-col :span="6" class="col">
                        <el-form-item label="手机号码" class="" prop="phone">
                            <el-input v-model="foreignForm.phone" class="width150"></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row class="cell">
                    <el-col :span="24" class="col">
                        <el-form-item label="备注" class="" prop="remark">
                            <el-input type="textarea" v-model="foreignForm.remark" style="display:block;width:100%"></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
            </el-row>
        ...
        <div slot="footer" class="dialog-footer">
            ...
            <el-button type="primary" @click="addItem('setForeignForm')">确认</el-button>
        </div>
    </el-dialog>
</div>
</template>
...
export default {
    ...
    methods: {
        ...
        getDataList() {
            ...
            this.loading = true;
            this.$F.doRequest(this, '/pms/foreignguest/list', this.searchForm, (res) => {
                this.loading = false
