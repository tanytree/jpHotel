    ...
    <el-card>
      ...
      >
        ...
        <el-table-column label="未结算">
          ...
          <el-table-column prop="createTime" label="挂账剩余总额" width="300"></el-table-column>
          <el-table-column prop="createTime" label="预收款余额" width="120"></el-table-column>
        </el-table-column>
        <el-table-column label="未结算">
          <el-table-column prop="createTime" label="已结算" width="120"></el-table-column>
          <el-table-column prop="createTime" label="现金" width="120"></el-table-column>
          <el-table-column prop="createTime" label="银行卡" width="300"></el-table-column>
          <el-table-column prop="createTime" label="预收款" width="120"></el-table-column>
          <el-table-column prop="createTime" label="微信" width="120"></el-table-column>
          <el-table-column prop="createTime" label="支付宝" width="120"></el-table-column>
          <el-table-column prop="createTime" label="免单" width="120"></el-table-column>
        </el-table-column>
