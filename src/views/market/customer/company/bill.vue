      ...
      " :visible.sync="dialogNew" width="700px" top="0" :close-on-click-modal="false" @close="dialogClose">
        ...
        <el-dialog :title="$t('desk.customer_lookBuyDetail')" v-if="advanceDialog" :visible.sync="advanceDialog" width="1160px" top="0">
            ...
            <el-table ref="multipleTable" v-loading="loading" :data="buyTable" height="100%" header-row-class-name="default" size="small">
                ...
                <el-table-column prop="onAccountTotal" :label="$t('desk.customer_amountPrice')" width="90">
                    <template slot-scope="{ row }">
                        {{ row.payPrice || 0 }}
                    </template>
                </el-table-column>
                ...
                <el-table-column prop="checkIn.id" :label="$t('desk.customer_originOrderNum')" width="300">
                </el-table-column>
                ...
                <el-table-column prop="checkIn.checkinTime" :label="$t('desk.order_checkinDateA')" width="160">
                </el-table-column>
                <el-table-column prop="checkIn.checkoutTime" :label="$t('desk.customer_checkoutTime')" width="160">
                </el-table-column>
            </el-table>
            ...
            this.$refs[formName].validate((valid) => {
                if (valid) {
                    if (
                        ...
                        this.enterForm.requestPrice > 0
                    ) {
                        if (
                            this.itemInfo.putupPrice -
                                this.itemInfo.requestPrice >
                            this.enterForm.requestPrice
                        ) {
                            ...
                            this.$message({
                                message: this.$t(
                                    "desk.customer_requestPriceShould"
                                ),
                                type: "warning",
                            });
                            this.enterForm.requestPrice =
                    ...
                    if (this.itemInfo.intoPrice > 0) {
                        if (
                            this.itemInfo.intoPrice < this.itemInfo.putupPrice
                        ) {
                    ...
                    this.$F.doRequest(
                        ...
                        (res) => {
                            this.$message({
                                message: this.$t(
                                    "desk.customer_continueRequestSuccess"
                                ),
                                type: "success",
                            });
                            this.enterForm = {
                    ...
                    if (this.addPlaceFrom.putupPrice > 0) {
                        if (
                            ...
                            if (
                                ...
                                this.$message({
                                    message: this.$t(
                                        "desk.customer_requestPriceNotMorethan"
                                    ),
                                    type: "warning",
                                });
                                return false;
                        ...
                        this.addPlaceFrom.operType =
                            this.clickType == "add" ? 1 : 2;
