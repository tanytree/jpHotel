 ...
 * @LastEditTime: 2020-10-26 15:15:09
        ...
        <div class="content">
            ...
            >
                ...
                >
                    ...
                    >
                        <template slot="append"
                            ><span @click="popup('guestTypeShow')"
                                >…</span
                            ></template
                        >
                    </el-input>
                    ...
                    <div class="roomBtm">
                        ...
                        >
                            ...
                            >
                                ...
                                <div class="row">
                                    <span class="allow"
                                        >可订{{ v.reserveTotal }}</span
                                    >
                                    <div>
                                        <el-input
                                            size="mini"
                                            class="num"
                                            v-model="v.discountPrice"
                    ...
                    <el-form inline size="small">
                        <el-form-item>
                            ...
                            <el-button
                                ...
                                v-if="
                                    !operCheckinType.startsWith('b') &&
                                    waitingRoom.length > 0
                                "
                                ><i v-loading="liveLoading"></i
                                >{{ $t("desk.order_rowHouses") }}</el-button
                            >
                            <el-button
                                @click="live_in_person_list"
                                v-if="
...
export default {
    ...
    methods: {
        ...
        db_row_houses() {
            ...
            this.waitingRoom[
                this.rowRoomCurrentIndex
            ] = this.rowRoomCurrentItem;
        ...
        empty_row_houses() {
            ...
            this.waitingRoom.forEach((element) => {
                let thisNum =
                    element.num -
                    (element.roomsArr ? element.roomsArr.length : 0);
                // number += thisNum
