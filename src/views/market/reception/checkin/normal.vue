  ...
  <div class="boss-index">
        ...
        <div class="right">
          <el-form inline size="small">
            <el-form-item>
              ...
              <el-button @click="live_in_person_list" v-if="!operCheckinType.startsWith('b')">
                <i v-loading="liveLoading"></i>添加入住人
              </el-button>
              <el-button @click="liveCard_in_person_list" v-if="!operCheckinType.startsWith('b')">
                <i v-loading="liveCardLoading"></i>制卡
              </el-button>
            </el-form-item>
          </el-form>
          <div class="roomBtm">
    ...
    >
      ...
      >
        ...
        <el-table-column prop="realPrice" label="房价" width="100"></el-table-column>
