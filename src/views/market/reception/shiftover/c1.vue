...
<div class="shiftOver">
    ...
    <el-row>
        ...
        <el-row>
            ...
            <el-col :span="6">
                <div class="item">迷你吧商品：<span  class="red">8000.00</span>日元</div>
            </el-col>
            <el-col :span="6">
                <div class="item">会员卡卡费：<span class="red">8000.00</span>日元</div>
            </el-col>
            <el-col :span="6">
    ...
    <el-row>
        <h3>本班现金上交&nbsp;&nbsp;<el-tag size="mini">当前交班模式：应收模式</el-tag>
        </h3>
    ...
    <el-row>
        ...
        <el-row>
            <el-col :span="4">
                <div class="item">交班报表(按班次)&nbsp; &nbsp;<el-button size="mini">预览</el-button>
                </div>
            </el-col>
            <el-col :span="4">
                <div class="item">交班报表(按收银员)&nbsp; &nbsp;<el-button size="mini">预览</el-button>
                </div>
            </el-col>
        </el-row>
    </el-row>
