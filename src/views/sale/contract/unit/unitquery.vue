...
<div>
    <el-card>
        ...
        <el-form inline size="small" >
            <el-row>
                <!-- <el-col :span="5"> -->
                    <el-form-item label="单位名称:">
                        <el-input style="width:170px" v-model="searchForm.content"></el-input>
                    </el-form-item>
                <!-- </el-col>

                <el-col > -->
                    <el-form-item label="状态:">
                        <el-select style="width:170px" v-model="searchForm.enterStatus">
                  ...
                  <el-form-item label="所属门店:">
                    ...
                    <el-form-item>
                        <el-form-item label="挂账额度:">
                            <el-input style="width:90px" v-model="searchForm.content"></el-input>
                        </el-form-item>
            ...
            <el-row>
                <el-form-item>
                    <el-button type="text">>>>前往设置单位价格</el-button>
                </el-form-item>
            </el-row>
        </el-form>
        <!--表格数据 -->
