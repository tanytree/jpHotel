  ...
  <div>
    <el-card>
      ...
      >
        ...
        <el-table-column prop="y_create_time" label="发起时间" show-overflow-tooltip></el-table-column>
        <el-table-column prop="co_name" label="采购商名称" show-overflow-tooltip></el-table-column>
        ...
        <el-table-column label="操作">
          <template slot-scope="{row}">
            ...
            <el-button type="text" size="mini">邀请处理</el-button>
          </template>
        </el-table-column>
      </el-table>
...
export default {
  ...
  methods: {
    initForm() {
      this.searchForm = {
        page: 1, //当前页
        type:"2",//1 清单列表 2 合同邀请列表 3 我发出的邀请列表
        page_num: 10, //页数
        keywords: "", //关键字
        start_time: "", //考试时件
        end_time: "" //结束时间
