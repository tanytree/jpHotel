<!--
 * @Date: 2020-03-20 10:51:35
 * @LastEditors: Dana
 * @LastEditTime: 2020-03-25 14:03:47
 * @FilePath: /cloudAdmin/src/views/sale/contract/start.vue
 -->
        ...
        <el-table-column label="操作">
          <template slot-scope="{row}">
            <el-button
              type="text"
              size="mini"
              @click="$router.push({name:'contractdetail',query:{id:row.id}})"
            >详情</el-button>
            <el-button
              type="text"
              size="mini"
              @click="$router.push({name:'contractinfo',query:{id:row.list_id}})"
            >合同文本</el-button>
          </template>
        </el-table-column>
      </el-table>
