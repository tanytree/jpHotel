<!--
 * @Date: 2020-03-23 10:30:49
 * @LastEditors: Dana
 * @LastEditTime: 2020-03-24 17:17:09
 * @FilePath: /cloudAdmin/src/views/sale/publicPool/index.vue
 -->
    ...
    <el-card>
      <el-form inline size="small">
        ...
        <el-form-item style="float:right">
          <el-button plain>添加客户</el-button>
          <el-divider direction="vertical"></el-divider>
          <el-badge :value="12" class="item">
            <el-button type="text">关联申请表</el-button>
          </el-badge>
        </el-form-item>
      </el-form>
      ...
      >
        ...
        <el-table-column prop="title" label="公司名称" show-overflow-tooltip></el-table-column>
        <el-table-column prop="create_time" label="联系人" show-overflow-tooltip></el-table-column>
        <el-table-column prop="b_rate" label="联系电话" show-overflow-tooltip></el-table-column>
