...
const $F = {
    ...
    compareAsc(propertyName) {
        return function(object1, object2) {
            ...
            // if (!(value1.match(/[a-zA-Z]/ig) && value2.match(/[a-zA-Z]/ig))) {
                value1 = parseInt(object1[propertyName]);
                value2 = parseInt(object2[propertyName]);
            // }
            if(value2 < value1) {
                return 1;
    ...
    substringDate(orgiDate, cutLength, length) {
        ...
        let newDate = orgiDate.substring(0, cutLength);
        if (!length) return newDate;
        return newDate.substring(0, cutLength - 2) + '00';
    },
    //
    formatDate(fmt, days, dateString, cutLength) {
    ...
    .noprint{
      ...
      .noprint{
        display:none;
            ...
            .innerDialogBox .contentBox .fifth_container {
              margin-top: 20px;
              display: flex;
              justify-content: flex-start;
              align-items: center;
            ...
            .innerDialogBox .contentBox .fifth_container .fifth_leftBox {
              width: 50%;
            }
            .innerDialogBox .contentBox .fifth_container .fifth_leftBox .boxDiv {
              border: 1px solid #727272;
              width: 100%;
            }
            .innerDialogBox .contentBox .fifth_container .fifth_leftBox .boxDiv .itemDiv {
              width: 100%;
            }
            .innerDialogBox .contentBox .fifth_container .fifth_leftBox .boxDiv .itemDiv table {
              width: 100%;
              border-bottom: 1px solid #727272;
              border-spacing: 0;
            }
            .innerDialogBox .contentBox .fifth_container .fifth_leftBox .boxDiv .itemDiv table tr {
              margin: 0;
              padding: 0;
            }
            .innerDialogBox .contentBox .fifth_container .fifth_leftBox .boxDiv .itemDiv table tr td {
              word-break: break-all;
              padding: 5px 0;
            }
            .innerDialogBox .contentBox .fifth_container .fifth_leftBox .boxDiv .itemDiv table tr td:nth-child(1) {
              width: 75%;
              border-right: 1px solid #727272;
              padding-left: 15px;
            }
            .innerDialogBox .contentBox .fifth_container .fifth_leftBox .boxDiv .itemDiv table tr td:nth-child(2) {
              width: 25%;
              text-align: center;
            }
            .innerDialogBox .contentBox .fifth_container .fifth_leftBox .boxDiv .itemDiv:nth-last-child(1) table {
              border: none;
            }
            .innerDialogBox .contentBox .fifth_container .fifth_rightBox {
              margin-left: 50px;
              font-size: 14px;
              color: #333333;
              width: 100px;
            ...
            .innerDialogBox .contentBox .textBox {
      ...
      .fifthTabel .fifth_container .fifth_leftBox {
        width: 55%;
      }
      .fifthTabel .fifth_container .fifth_leftBox .boxDiv {
        border: 1px solid #727272;
        width: 100%;
      }
      .fifthTabel .fifth_container .fifth_leftBox .boxDiv .itemDiv {
        width: 100%;
      }
      .fifthTabel .fifth_container .fifth_leftBox .boxDiv .itemDiv table {
        width: 100%;
        border-bottom: 1px solid #727272;
        border-spacing: 0;
      }
      .fifthTabel .fifth_container .fifth_leftBox .boxDiv .itemDiv table tr {
        margin: 0;
        padding: 0;
      }
      .fifthTabel .fifth_container .fifth_leftBox .boxDiv .itemDiv table tr td {
        word-break: break-all;
        padding: 5px 0;
      }
      .fifthTabel .fifth_container .fifth_leftBox .boxDiv .itemDiv table tr td:nth-child(1) {
        width: 75%;
        border-right: 1px solid #727272;
        padding-left: 15px;
      }
      .fifthTabel .fifth_container .fifth_leftBox .boxDiv .itemDiv table tr td:nth-child(2) {
        width: 25%;
        text-align: center;
      }
      .fifthTabel .fifth_container .fifth_leftBox .boxDiv .itemDiv:nth-last-child(1) table {
        border: none;
      }
