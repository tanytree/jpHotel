...
module.exports = {
    ...
    home_balanceOf: '未翻译词条',
    home_accountDetail: '未翻译词条',
    home_owe:'未精算',
    home_iconShows:'表示説明',
    home_drawUp:'未翻译词条',
    home_bookRoom:'仮押え',
    ...
    home_buyNet:'未翻译词条',
    home_stayOver:'未翻译词条',
    home_needLeave:'未翻译词条',
    home_orignLeaveTime:'未翻译词条',
    home_stayOverDay:'未翻译词条',
    home_newLeaveTime:'未翻译词条',
    home_hejiRoomPrice:'未翻译词条',
    home_changeRoom:'未翻译词条',
    ...
    home_resetRemark:'未翻译词条',
    home_sureService:'未翻译词条',
    home_noPeopleLive:'未翻译词条',
    home_shouldSelectRoom:'未翻译词条',
    home_chooseRoom:'部屋情報入力',
    home_chooseNeedRoom:'未翻译词条',
    home_selected:'未翻译词条',
    home_allSelected:'全部',
    home_bulkDirty:'一括未清掃',
    home_bulkClear:'一括清掃済み',
    home_thisOperate:'未翻译词条',
    home_modityReserved:'仮押さえ変更',
    home_describeText:'未翻译词条',
    home_canOrderText:'未翻译词条',
    home_attribute:'部屋の特徴',
    home_haveWindow:'窓有り',
    home_onRoad:'道路沿い',
    home_noSmoke:'ノースモーク',
    home_perfectLiveInfo:'未翻译词条',
    home_morethenNum:'未翻译词条',
    home_inputLiveAfter:'请输入入住信息后操作',
    home_roomTypeOperate:'未翻译词条',
    home_selectToTime:'未翻译词条',
    home_chooseList: '未翻译词条',
    home_clickChoose:'未翻译词条',
    home_AlList:'未翻译词条',
    home_nowAl:'未翻译词条',
    home_sureAl:'未翻译词条',
    serve_conferenceInfo: '未翻译词条',
    serve_nameQuery: '未翻译词条',
    book_roomPriceText: '未翻译词条',
    serve_placeChooseRoom: '未翻译词条',
    book_haveCertified: '未翻译词条',
    book_notCertified: '未翻译词条',
    order_checkinState: "宿泊状態",
    order_roomPriceTotal: "部屋料金合計",
    order_makeCardInfo: "部屋キーカード情報",
    order_customerType: "未翻译词条",
    order_memberType: "未翻译词条",
    order_notMember: "未翻译词条",
    order_lookOrderInfo: "未翻译词条",
    order_cancelOrder: "未翻译词条",
    order_bookRoomType: "予約部屋タイプ",
    order_noText: "未翻译词条",
    order_changeSource: "予約経路変更",
    order_priceShould: "未翻译词条",
    order_toLiveTime: "入离时间",
    order_goodsUnit: "単価（円）",
    order_empoyeePrice: "未翻译词条",
    order_atEmpoyee: "未翻译词条",
    order_nofood: "未翻译词条",
    order_selectGoods: "商品を選択してください。",
    order_selectRoomNum: "未翻译词条",
    order_partBill: "未翻译词条",
    order_billExplain: "未翻译词条",
    order_saleDay: "営業日",
    order_allPay: "未翻译词条",
    order_cachRefund: "キャッシュ返金",
    order_keepLive: "滞在中",
    order_alreadyCheckout: "未翻译词条",
    customer_nameSpell: '未翻译词条',
    customer_resetSuccess: '未翻译词条',
    customer_sureDisabled: '未翻译词条',
