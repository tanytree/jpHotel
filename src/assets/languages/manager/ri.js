...
module.exports = {
  ...
  grsl_goodsTax: '消費税は含まれていますか',
  grsl_goodsTaxN: '税抜き',
  grsl_goodsTaxY: '税込み',
  grsl_goodsService: 'サービス料は含まれていますか',
  grsl_goodsServiceN: 'サービス料は含まれていません',
  grsl_goodsServiceY: 'サービス料込み',
