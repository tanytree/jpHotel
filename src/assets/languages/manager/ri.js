...
module.exports = {
    ...
    hk_batchModify: '列別一括編集',
    hk_hardWare: 'ディバイス',
    hk_lock: '錠の番号',
    hk_interfaceType: 'インタフェース類別',
    hk_roomLockInfo: '部屋鍵情報',
    ...
    grsl_confirm: '確認',
    grsl_cancle: '取り消し',
    grsl_deleteContent: '該当操作は削除となり、継続しますか？',
