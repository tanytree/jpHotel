 ...
 * @Author: 陶子
 * @LastEditTime: 2020-12-29 11:43:30
 * @FilePath: \jiudian\src\components\cardTao.vue
-->
<template>
    <!-- 挂账dialog组件-->
    <el-dialog top="0" width="40%" title="挂账" :visible.sync="paymentVisible" append-to-body>
        ...
        <el-form ref="paymentForm" :rules="paymentRules" :model="paymentForm" label-width="110px">
            ...
            <el-form-item label="挂账方式" prop="putUp">
                <el-select v-model="paymentForm.putUp" placeholder="请选择挂账方式" style="width: 260px">
        ...
        <span slot="footer" class="dialog-footer">
            ...
            <el-button type="primary" @click="consume_oper('paymentForm')">确认</el-button>
        </span>
    </el-dialog>
</template>
<script>
