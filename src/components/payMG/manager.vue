        ...
        <div class="booking flex_column">
            <el-form class="term" inline size="small">
                <el-form-item :label="$t('boss.loginDetail_stores')" v-if="storesNum == $F.getHQCode()">
                    <el-select v-model="payManagerForm.storesNum" :placeholder="$t('boss.compensation_selectState')">
                ...
                <el-form-item :label="$t('boss.compensation_payMonth')+':'">
                    <el-date-picker v-model="payManagerForm.payTime" type="month" :placeholder="$t('boss.compensation_selectMonth')" value-format="yyyy-MM"></el-date-picker>
                </el-form-item>
                <el-form-item :label="$t('boss.staff_staffState')+':'">
                    <el-select v-model="payManagerForm.userStatus" :placeholder="$t('boss.compensation_selectState')">
                        <el-option :label="$t('commons.all')" value>{{$t('commons.all')}}</el-option>
                        <el-option :label="label" :value="value" :key="value" v-for="(label, value) in $t('commons.userStatus')"></el-option>
                    </el-select>
                </el-form-item>
                <el-form-item>
                    <el-button type="primary" class="submit" @click="get_salary_mg_list">{{$t('commons.queryBtn')}}</el-button>
                </el-form-item>
            </el-form>
            <el-table ref="multipleTable" :data="payManagerTableData" height="100%" header-row-class-name="default" size="small">
                ...
                <el-table-column fixed="right" :label="$t('commons.operating')" width="160">
                    <template slot-scope="scope">
                        ...
                        >{{$t('boss.compensation_employeeDetails')}}
                        </el-button>
                        <el-button
                                type="text"
                                size="small"
