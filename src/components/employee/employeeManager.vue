  ...
  <div class="sec1 boss-index">
    ...
    <div>
      ...
      >
        ...
        <el-table-column prop="inTime" :label="$t('boss.staff_workTime')" show-overflow-tooltip></el-table-column>
        ...
        <el-table-column :label="$t('commons.operating')" width="300">
          <template slot-scope="{row}">
            ...
            >{{$t('commons.forDeparture')}}</el-button>
            <el-button
              type="text"
              size="mini"
              @click="becoming(row)"
              v-if="row.userStatus!=1"
            >{{$t('commons.positive')}}</el-button>
              ...
              <el-form-item :label="$t('boss.staff_leavingFile')+'：'">
                ...
                >
                  <template slot="append">
                    ...
                    >
                      <el-button size="small" type="primary">{{$t('boss.staff_clickUp')}}</el-button>
                    </el-upload>
                  </template>
                </el-input>
              </el-form-item>
