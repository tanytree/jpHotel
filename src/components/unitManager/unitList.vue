	...
	<div>
			...
			<div class="components-edit">
				<el-table ref="multipleTable" :data="tableData" tooltip-effect="dark" :header-cell-style="{background:'#F7F7F7',color:'#1E1E1E'}">
					...
					<el-table-column label="操作" width="350">
						<template slot-scope="{row}">
							<el-button type="text" size="small" @click="popup('see', row)">查看</el-button>
							<el-button type="text" size="small" @click="popup('change', row)">修改</el-button>
							<el-popconfirm title="这是一段内容确定删除吗？" @onConfirm="get_price_enter_strategy_delete(row)">
								<el-button slot="reference" type="text" size="small"  v-if="row.state == 0">删除</el-button>
							</el-popconfirm>
							<el-button type="text" size="small" @click="popup('changerili')"  v-if="row.state == 0">修改日历</el-button>
						</template>
					</el-table-column>
				</el-table>
			</div>
		...
		<el-row v-if="!tab1_show">
			...
			<el-row style="padding: 20px 0px;">
				...
				<el-button style="width: 80px;margin-left: 20px; cursor: pointer" @click="back_1()">返回</el-button>
			</el-row>
		</el-row>
