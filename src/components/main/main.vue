              ...
              <div class="el-tabs__nav-wrap is-top">
                <div class="el-tabs__nav-scroll">
                  <div class="el-tabs__nav is-top">
                    <div class="el-tabs__item is-top" :class="pageId==item.id?'is-active':''" v-for="(item,index) in subMenul.children"
                         :key="index" @click="toPage(item)">{{item.name}}</div>
                  </div>
                </div>
              </div>
            </div>
      ...
      this.routeractions([
        ...
        },
        {
          ...
          children: [
            ...
            { name: this.$t('tabName[3].children[2].name'), id: "42", icon: "market/nav03.png", value: "reception" },
